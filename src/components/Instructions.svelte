<div class="flex flex-col gap-6">
    <p>
        This test evaluates your reaction time, coordination, and ability to respond correctly to visual and auditory
        stimuli.
    </p>
    ...
    <div class="flex flex-col gap-1">
        ...
        Your performance is based on reaction time and accuracy—try to respond as quickly and correctly as possible.
    </div>
</div>